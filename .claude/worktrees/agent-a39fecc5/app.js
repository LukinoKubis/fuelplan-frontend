...
const MEM = {
  ...
  clear() { ['fp_plan','fp_planName','fp_userName','fp_profile','fp_shopChecks','fp_activeSection','fp_activeDay','fp_apikey','fp_eaten','fp_mealNotes','fp_mealAnnotations','fp_prepSession','fp_activePlanId','fp_activePlanSavedAt','fp_favorites'].forEach(k => { try { localStorage.removeItem(k); } catch(e) {} }); }
};
